...
import { FileCode, UserCheck, ShieldAlert, Cpu, Sparkles } from "lucide-react";
    ...
    <div className="space-y-8 max-w-5xl mx-auto pb-12 animate-fade-in-up">
      ...
      <div className="border-b border-white/10 pb-6">
        ...
        <p className="text-xs font-mono text-neutral-400 mt-1">
          PARSE UNSTRUCTURED PDF CORPUS &rarr; NORMALIZE INTO DAG SKILL NODES
        </p>
      </div>
      ...
      <div className="border border-white/10 bg-[#0d0d0d] p-6 space-y-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-mono text-xs font-bold uppercase tracking-wider text-white">
            BINARY PDF INGESTION ZONE
          </h2>
        </div>

        <Dropzone onUploadSuccess={(res) => setExtractedData(res)} />
      </div>

      {/* Target Role & Profile Specification */}
        ...
        <div className="p-6 border border-white/10 bg-[#0d0d0d] space-y-4">
          ...
          <div className="space-y-3 font-mono text-xs">
            ...
            <div>
              ...
              <span className="text-neutral-300">Deterministic AST + Semantic Embeddings</span>
            </div>
          </div>
        </div>
